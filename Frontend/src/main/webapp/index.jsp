...
<body>
    ...
    <div class="item active">
        <img src="<c:url value="/resources/images/1.png" />" alt="Image">     
      </div>
      <div class="item">
        <img src="<c:url value="/resources/images/img1.jpg" />" alt="Image">     
      </div>

      <div class="item">
        <img src="<c:url value="/resources/images/img2.jpg" />" alt="Image">     
      </div>
    <div class="item">
        <img src="<c:url value="/resources/images/img3.jpg" />" alt="Image">     
      </div>
    <div class="item">
       <img src="<c:url value="/resources/images/img4.jpg" />" alt="Image">      
      </div>
    </div>
